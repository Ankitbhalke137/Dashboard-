...
const StudentProfile = lazy(() => import('./components/directory/StudentProfile'));
...
export default function App() {
  ...
  const renderPage = () => {
    switch (activeTab) {
      case 'directory': return <DirectoryPage onViewProfile={(id) => handleNavigate('student-profile', { studentId: id })} />;
      case 'student-profile': return <StudentProfile studentId={studentId} onBack={() => handleNavigate('directory')} />;
