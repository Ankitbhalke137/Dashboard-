...
export default function ProjectCard({ student, index = 0, onViewProfile }) {
    ...
    <div className="glass-card rounded-xl overflow-hidden group">
      ...
      <div className="px-4 pb-4">
        ...
        <div className="flex items-center gap-2 mt-4 pt-3 border-t border-white/5">
          ...
          <button onClick={() => onViewProfile?.(student._id)} className="text-[10px] font-mono text-primary-container border border-primary-container/30 px-2.5 py-1 rounded-md hover:bg-primary-container/10 transition-all opacity-0 group-hover:opacity-100">
            View Profile
          </button>
        </div>
      </div>
